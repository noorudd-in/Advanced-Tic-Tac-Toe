      ...
      <div className="my-10">
        ...
        <div className="flex justify-center mt-10">
          <div>
            <div className="flex">
              <div
                className="px-20 py-10 bg-orange-400 rounded-lg"
              ...
              <div
                className="p-10 bg-orange-600 rounded-t-lg"
            ...
            <div className="flex">
              ...
              <div
                className="px-10 py-1 bg-orange-600 m-0"
                onClick={redirectToAdvanced}
              ></div>
            </div>
            <div className="flex">
              <div
                className="px-10 py-10 bg-orange-500 rounded-lg"
              ...
              <div className="px-1 py-10"></div>
              <div
                className="px-20 py-10 bg-orange-600 rounded-l-lg rounded-br-lg"
                onClick={redirectToAdvanced}
              >
            ...
            <div className="flex">
              <div
                className="px-[124px] py-10 bg-orange-700 rounded-lg"
